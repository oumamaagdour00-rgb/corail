...
const TaglineHassa: React.FC<TaglineProps> = ({ className = '' }) => {
    ...
    return (
        ...
        >
            <div
                style={{
                    backgroundImage: 'url("/assets/hassa.webp")',
            ...
            <div className={`relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex items-center justify-center transition-all duration-[1500ms] delay-500 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-display font-bold text-white leading-relaxed md:leading-snug tracking-wide break-words" style={{ wordWrap: 'break-word', overflowWrap: 'break-word' }}>
                    {phrase}
                </h2>
            </div>
        </section>
