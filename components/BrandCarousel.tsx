    ...
    return (
        <section className="py-12 bg-corail-900 overflow-hidden relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-8 relative z-30">
                <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-[36px] font-display font-bold text-white mb-4 break-words" style={{ wordWrap: 'break-word', overflowWrap: 'break-word' }}>{t.home.brandsTitle}</h2>
